...
roi <- as.matrix(fread("~/Desktop/571Datasets/Project_data/roi.csv",skip=1, header=FALSE))[,-1]
roi_names <- as.matrix(fread("~/Desktop/571Datasets/Project_data/roi_names.csv",skip=1, header=FALSE))
```


Find the dimension of the dataframe to be 1750 units by 8000 voxels of each unit, which is a stimuli picture.
```{r}
dim(responses)
